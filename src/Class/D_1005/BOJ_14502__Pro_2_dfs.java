...
public class BOJ_14502__Pro_2_dfs {
	...
	// 선택된 벽을 세우는 위치
	static int[][] wall = new int[3][2]; // 항상 세개 // wall[2][0] => 3번째 벽의 y 좌표 // wall[2][1] => 3번째 벽의 x 좌표
	...
	static void comb(int srcIdx, int tgtIdx) {
		...
		// 2번 재귀호출 사용 => srcIdx 에 대해서도 기저조건 처리
		if (srcIdx == zeroSize)
			return;

		wall[tgtIdx] = zero.get(srcIdx); // 선택 가능한 0 위치를 순서대로 srcIdx를 선택
