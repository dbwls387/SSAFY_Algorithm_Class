// SWEA 4012번 [모의 SW 역량테스트] 요리사 - 교수님 풀이
...
public class SWEA_4012__Pro {
	...
	// A : 1, 3, 4
	// B : 0, 2, 5
	static boolean[] select; // 재료 중 어떤 index의 재료가 선택되었는지 표현
...
//		System.setIn(new FileInputStream("input.txt"));
	...
	static void comb(int srcIdx, int tgtIdx) {
		...
		// src로부터 선택된 항목을 tgt 자료구조에 담고 이어가는 게 (덮어쓰게 된다) 아니라, select에 표시 이어간다.
		select[srcIdx] = true;
	...
	static void check() {
		// 나누어진 2개의 배열에 select를 이용해서 각각 원재료의 index를 확보
